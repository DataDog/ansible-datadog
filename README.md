...
| `datadog_agent_version`                                                                                                                         | The pinned version of the Agent to install (optional, but highly recommended). Example: `7.15.0`. Setting `datadog_agent_major_version` is not needed if `datadog_agent_version` is used. **Note** Downgrades are not supported on Windows platforms. |
