...
- When using Ansible 2.10+, requires the `ansible.windows` collection to be installed. That collection is automatically installed with the `ansible` pip package. Alternatively, you can install it with:
