...
| `datadog_inject_apm_flavor`                 | Default Package name for APM Library Injection APT and RPM installs - can override in playbook for IOT Agent.                                                                                                                                                                                                                                                                                                                                     |
| `datadog_apm_instrumentation_enabled`       | Configure APM host injection. Possible values are: `all`, `host` or `docker`.                                                                                                                                                                                                                                                                                                                                                                     |
